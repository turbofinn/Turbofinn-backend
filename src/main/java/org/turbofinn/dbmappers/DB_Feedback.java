...
public class DB_Feedback extends DB_DateTable{
    public static void main(String[] args) {
        ...
        dbFeedback.setUserId("cwcsdcdvsv");
        dbFeedback.setRestaurantId("dvsvsdvsdv");
        dbFeedback.setMessage("Great food and excellent service!");
        dbFeedback.setRating("5adcdacd");
        dbFeedback.initializeTimestamp();
        dbFeedback.save();
    }
    @DynamoDBHashKey
